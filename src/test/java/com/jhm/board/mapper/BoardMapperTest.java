...
//
//        List<BoardResponse> posts = boardMapper.findAll(pageable);
...
//    @Test
//    void delete() {
//        System.out.println("삭제 이전의 전체 게시글 개수는 : " + boardMapper.findAll(pageable).size() + "개입니다.");
//        boardMapper.deleteById(1L);
//        System.out.println("삭제 이후의 전체 게시글 개수는 : " + boardMapper.findAll(pageable).size() + "개입니다.");
//
////        assertThat(boardMapper.findAll(pageable).size()).isEqualTo(0);
//    }
//
//    @Test
//    void findAll() {
